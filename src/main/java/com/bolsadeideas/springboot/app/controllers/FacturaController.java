...
public class FacturaController {
	...
	public String crear(@PathVariable("clienteId") long id, Map<String, Object> model, RedirectAttributes flash, Locale locale) {
	...
	public @ResponseBody List<Producto> cargarProdutos(@PathVariable String term){
